...
class DualCompose:
    ...
    def __call__(self, x, mask=None):
        for t in self.transforms:
            x, mask = t(x, mask)
            print(f"shape tras trasform {t.__class__.__name__}: {mask.shape}")
        return x, mask
...
class Normalize:  # VHR PeruSat
    def __init__(self, maxi=3521, mean=(0.11383374, 0.10310764, 0.11405758, 0.13963067),
